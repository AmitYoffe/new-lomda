/*
  ...
  - You are about to drop the column `lastEditDate` on the `question` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `question` DROP COLUMN `lastEditDate`,
